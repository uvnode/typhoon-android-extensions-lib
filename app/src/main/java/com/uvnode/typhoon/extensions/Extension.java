...
public class Extension {
    ...
    public static Extension createDefault(Context context) {
        return new Extension(context.getApplicationInfo().nonLocalizedLabel.toString(), BuildConfig.VERSION_NAME, BuildConfig.VERSION_CODE, context.getPackageName());
    }
